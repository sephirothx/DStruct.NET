...
namespace DStruct.BinaryTrees
{
    ...
    public interface IBinarySearchTree<T>
    {
        ...
        /// <summary>
        /// Gets the minimum value element stored in the <see cref="IBinarySearchTree{T}"/>.
        /// </summary>
        T Min { get; }

        /// <summary>
        /// Gets the maximum value element stored in the <see cref="IBinarySearchTree{T}"/>.
        /// </summary>
        T Max { get; }
        ...
        /// <summary>
        /// Inserts an element into the <see cref="IBinarySearchTree{T}"/> and returns its index.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the <see cref="IBinarySearchTree{T}"/> contains a specific value.
        /// </summary>
        ...
        /// <summary>
        /// Removes one occurrence of a specific element from the <see cref="IBinarySearchTree{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns the list of the elements stored in the <see cref="IBinarySearchTree{T}"/> in-order.
        /// </summary>
        /// <returns>List of in-order elements.</returns>
        IEnumerable<T> InOrderTraverse();

        /// <summary>
        /// Returns the list of the elements stored in the <see cref="IBinarySearchTree{T}"/> pre-order.
        /// </summary>
        /// <returns>List of pre-order elements.</returns>
        IEnumerable<T> PreOrderTraverse();

        /// <summary>
        /// Returns the list of the elements stored in the <see cref="IBinarySearchTree{T}"/> post-order.
        /// </summary>
        ...
        IEnumerable<T> BreadthFirstSearch();
    }
}
